...
naam = listen_flexa()
if naam == "~":
   speak("Couldn't understand your name. For my convinience I'll be calling you Mridul Gupta")
   naam = "Mridul Gupta"
...
while True:
    ...
    # this case is for comedy
        ...
        outtext = "I am in relationship with Mridul Gupta"
        speak(outtext)
    ...
    # this case will search anything in wikipedia and respond's accordingly
        ...
        if out=="~":
            ...
            speak(out)
    # this will pause flexa for some due course of time
